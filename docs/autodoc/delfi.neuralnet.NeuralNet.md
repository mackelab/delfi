...
??? info "Source Code" 
	...
	```
### *NeuralNet*.**init\_mdn**`#!py3 (self, svi=False, n_components=1, rank=None, mdn_actfun=<function tanh at 0x12eade4d0>, homoscedastic=False, min_precisions=None, **unused_kwargs)` { #init\_mdn data-toc-label=init\_mdn }
